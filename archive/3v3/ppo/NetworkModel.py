...
class NetworkModel(nn.Module):
    def __init__(self):
        ...
        self.value_mlp = MLP([192, 64, 1], "hero_value_mlp")
    ...
    def forward(self, data_list):
        ...
        for hero_index in range(self.hero_num):
            ...
            hero_result_list.append(
                self.value_mlp(hero_public_second_result_list[hero_index])
            )
    ...
    def compute_loss(self, data_list, rst_list):
        ...
        for hero_index, hero_data in enumerate(data_list):
            ...
            # loss of value net
            value_cost = (
                torch.square((_hero_reward_list[0] - _hero_value_result))
