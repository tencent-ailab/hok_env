...
echo "`hostname -i` root 36001 $CPU_NUM" > /code/cpu_code/script/cpu.iplist
...
while read ip user port password;do
    echo $ip
...
mv mem_pool.host_list /code/cpu_code/actor/config/mem_pool.host_list
